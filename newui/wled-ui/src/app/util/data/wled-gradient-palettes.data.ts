import { UiPalette } from "../ui-color";

export const ib_jul01_gp = UiPalette.fromBytes([
	0, 194,  1,  1,
	94,   1, 29, 18,
	132,  57,131, 28,
	255, 113,  1,  1
...
export const es_vintage_57_gp = UiPalette.fromBytes([
	0,   2,  1,  1,
	53,  18,  1,  0,
	104,  69, 29,  1,
	153, 167,135, 10,
...
export const es_vintage_01_gp = UiPalette.fromBytes([
	0,   4,  1,  1,
	51,  16,  0,  1,
	76,  97,104,  3,
	101, 255,131, 19,
...
export const es_rivendell_15_gp = UiPalette.fromBytes([
	0,   1, 14,  5,
	101,  16, 36, 14,
	165,  56, 68, 30,
	242, 150,156, 99,
...
export const rgi_15_gp = UiPalette.fromBytes([
	0,   4,  1, 70,
	31,  55,  1, 30,
	63, 255,  4,  7,
	95,  59,  2, 29,
...
export const retro2_16_gp = UiPalette.fromBytes([
	0, 188,135,  1,
	255,  46,  7,  1
]);
...
export const Analogous_1_gp = UiPalette.fromBytes([
	0,   3,  0,255,
	63,  23,  0,255,
	127,  67,  0,255,
	191, 142,  0, 45,
...
export const es_pinksplash_08_gp = UiPalette.fromBytes([
	0, 126, 11,255,
	127, 197,  1, 22,
	175, 210,157,172,
	221, 157,  3,112,
...
export const es_ocean_breeze_036_gp = UiPalette.fromBytes([
	0,   1,  6,  7,
	89,   1, 99,111,
	153, 144,209,255,
	255,   0, 73, 82
...
export const departure_gp = UiPalette.fromBytes([
	0,   8,  3,  0,
	42,  23,  7,  0,
	63,  75, 38,  6,
	84, 169, 99, 38,
...
export const es_landscape_64_gp = UiPalette.fromBytes([
	0,   0,  0,  0,
	37,   2, 25,  1,
	76,  15,115,  5,
	127,  79,213,  1,
...
export const es_landscape_33_gp = UiPalette.fromBytes([
	0,   1,  5,  0,
	19,  32, 23,  1,
	38, 161, 55,  1,
	63, 229,144,  1,
...
export const rainbowsherbet_gp = UiPalette.fromBytes([
	0, 255, 33,  4,
	43, 255, 68, 25,
	86, 255,  7, 25,
	127, 255, 82,103,
...
export const gr65_hult_gp = UiPalette.fromBytes([
	0, 247,176,247,
	48, 255,136,255,
	89, 220, 29,226,
	160,   7, 82,178,
...
export const gr64_hult_gp = UiPalette.fromBytes([
	0,   1,124,109,
	66,   1, 93, 79,
	104,  52, 65,  1,
	130, 115,127,  1,
...
export const GMT_drywet_gp = UiPalette.fromBytes([
	0,  47, 30,  2,
	42, 213,147, 24,
	84, 103,219, 52,
	127,   3,219,207,
...
export const ib15_gp = UiPalette.fromBytes([
	0, 113, 91,147,
	72, 157, 88, 78,
	89, 208, 85, 33,
	107, 255, 29, 11,
...
export const Tertiary_01_gp = UiPalette.fromBytes([
	0,   0,  1,255,
	63,   3, 68, 45,
	127,  23,255,  0,
	191, 100, 68,  1,
...
export const lava_gp = UiPalette.fromBytes([
	0,   0,  0,  0,
	46,  18,  0,  0,
	96, 113,  0,  0,
	108, 142,  3,  1,
...
export const fierce_ice_gp = UiPalette.fromBytes([
	0,   0,  0,  0,
	59,   0,  9, 45,
	119,   0, 38,255,
	149,   3,100,255,
...
export const Colorfull_gp = UiPalette.fromBytes([
	0,  10, 85,  5,
	25,  29,109, 18,
	60,  59,138, 42,
	93,  83, 99, 52,
...
export const Pink_Purple_gp = UiPalette.fromBytes([
	0,  19,  2, 39,
	25,  26,  4, 45,
	51,  33,  6, 52,
	76,  68, 62,125,
...
export const Sunset_Real_gp = UiPalette.fromBytes([
	0, 120,  0,  0,
	22, 179, 22,  0,
	51, 255,104,  0,
	85, 167, 22, 18,
...
export const Sunset_Yellow_gp = UiPalette.fromBytes([
	0,  10, 62,123,
	36,  56,130,103,
	87, 153,225, 85,
	100, 199,217, 68,
...
export const Beech_gp = UiPalette.fromBytes([
	0, 255,252,214,
	12, 255,252,214,
	22, 255,252,214,
	26, 190,191,115,
...
export const Another_Sunset_gp = UiPalette.fromBytes([
	0, 110, 49, 11,
	29,  55, 34, 10,
	68,  22, 22,  9,
	68, 239,124,  8,
...
export const es_autumn_19_gp = UiPalette.fromBytes([
	0,  26,  1,  1,
	51,  67,  4,  1,
	84, 118, 14,  1,
	104, 137,152, 52,
...
export const BlacK_Blue_Magenta_White_gp = UiPalette.fromBytes([
	0,   0,  0,  0,
	42,   0,  0, 45,
	84,   0,  0,255,
	127,  42,  0,255,
...
export const BlacK_Magenta_Red_gp = UiPalette.fromBytes([
	0,   0,  0,  0,
	63,  42,  0, 45,
	127, 255,  0,255,
	191, 255,  0, 45,
...
export const BlacK_Red_Magenta_Yellow_gp = UiPalette.fromBytes([
	0,   0,  0,  0,
	42,  42,  0,  0,
	84, 255,  0,  0,
	127, 255,  0, 45,
...
export const Blue_Cyan_Yellow_gp = UiPalette.fromBytes([
	0,   0,  0,255,
	63,   0, 55,255,
	127,   0,255,255,
	191,  42,255, 45,
...
export const Orange_Teal_gp = UiPalette.fromBytes([
	0,   0,150, 92,
	55,   0,150, 92,
	200, 255, 72,  0,
	255, 255, 72,  0
...
export const Tiamat_gp = UiPalette.fromBytes([
	0,   1,  2, 14, //gc
...
export const April_Night_gp = UiPalette.fromBytes([
	0,   1,  5, 45, //deep blue
	10,   1,  5, 45,
...
export const Orangery_gp = UiPalette.fromBytes([
	0, 255, 95, 23,
	30, 255, 82,  0,
	60, 223, 13,  8,
	90, 144, 44,  2,
...
export const C9_gp = UiPalette.fromBytes([
	0, 184,  4,  0, //red
	60, 184,  4,  0,
	65, 144, 44,  2, //amber
	125, 144, 44,  2,
...
export const Sakura_gp = UiPalette.fromBytes([
	0, 196, 19, 10,
	65, 255, 69, 45,
	130, 223, 45, 72,
	195, 255, 82,103,
...
export const Aurora_gp = UiPalette.fromBytes([
	0,   1,  5, 45, //deep blue
	64,   0,200, 23,
	128,   0,255,  0, //green
	170,   0,243, 45,
...
export const Atlantica_gp = UiPalette.fromBytes([
	0,   0, 28,112, //#001C70
	50,  32, 96,255, //#2060FF
	100,   0,243, 45,
	150,  12, 95, 82, //#0C5F52
...
export const C9_2_gp = UiPalette.fromBytes([
	0,   6, 126,   2, //green
	45,   6, 126,   2,
	45,   4,  30, 114, //blue
	90,   4,  30, 114,
...
export const C9_new_gp = UiPalette.fromBytes([
	0, 255,   5,   0, //red
	60, 255,   5,   0,
...
export const temperature_gp = UiPalette.fromBytes([
	0,   1, 27,105,
	14,   1, 40,127,
	28,   1, 70,168,
	42,   1, 92,197,
...
// by name every time.
export const wledGradientPalettes = [
...
export const wledGradientPaletteNames = [
